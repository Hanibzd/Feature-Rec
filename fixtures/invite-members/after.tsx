// components/MembersCard.tsx  (AFTER)
const members = [
  ...
  return (
    <div className="rounded-2xl bg-[#16161F] shadow-2xl ring-1 ring-white/5 w-[840px]">
      <div className="px-10 h-[110px] flex items-center justify-between border-b border-white/10">
        ...
        {/* New: invite teammates */}
        <button className="flex items-center gap-2 h-[48px] w-[150px] justify-center rounded-xl bg-[#6C5CE7] text-white text-base font-semibold">
